package de.lukonjun.podwatcher.data;

import de.lukonjun.podwatcher.controller.PodController;
import de.lukonjun.podwatcher.influxdb.InfluxController;
...
import de.lukonjun.podwatcher.model.MetricsFilter;
...
public class DataAggregator {
    ...
    public void decisionTree() throws Exception {
        ...
        for(MetricsFilter filter:filterList) {
            ...
            // Write to File
            de.lukonjun.podwatcher.helper.FileWriter.writeArffFile(instancesWithFilter,path,filter.getName());
            ...
            de.lukonjun.podwatcher.helper.FileWriter.writeToFile(wekaModel.toString(),path + filter.getName() + "-model");
